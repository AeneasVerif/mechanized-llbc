...
Parameter alloc: forall (m: mem) (lo hi al: Z), mem * block.
...
Parameter block_align: mem -> block -> Z.
...
Definition valid_access (m: mem) (chunk: memory_chunk) (b: block) (ofs: Z) (p: permission): Prop :=
  ...
  /\ (align_chunk chunk | block_align m b).
...
Axiom storebytes_store:
  ...
  (align_chunk chunk | ofs) ->
  (align_chunk chunk | block_align m1 b) ->
  store chunk m1 b ofs v = Some m2.
...
Axiom alloc_result:
  forall m1 lo hi al m2 b, alloc m1 lo hi al = (m2, b) ->
  b = nextblock m1.
...
Axiom alloc_left_mapped_inject:
  ...
  (lo < hi -> ((al | delta) /\ (al | block_align m2 b2))) ->
