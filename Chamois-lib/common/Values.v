...
Definition divs_exact (v1 v2: val): option val :=
  match v1, v2 with
  | Vint n1, Vint n2 =>
      if Int.eq n1 (Int.repr Int.min_signed) && Int.eq n2 Int.mone
      then None
      else
        match Int.divs_exact n1 n2 with
        | Some v => Some (Vint v)
        | None => None
        end
  | _, _ => None
...
Definition divu_exact (v1 v2: val): option val :=
  match v1, v2 with
  | Vint n1, Vint n2 =>
      match Int.divu_exact n1 n2 with
      | Some v => Some (Vint v)
      | None => None
      end
  | _, _ => None
...
Definition sqrtf (v1: val) : val :=
  match v1 with
  | Vfloat f1 => Vfloat(Float.sqrt f1)
  | _ => Vundef
  end.
...
Definition sqrtfs (v1: val) : val :=
  match v1 with
  | Vsingle f1 => Vsingle(Float32.sqrt f1)
  | _ => Vundef
  end.
...
Definition divls_exact (v1 v2: val): option val :=
  match v1, v2 with
  | Vlong n1, Vlong n2 =>
      if Int64.eq n1 (Int64.repr Int64.min_signed) && Int64.eq n2 Int64.mone
      then None
      else
        match Int64.divs_exact n1 n2 with
        | Some v => Some (Vlong v)
        | None => None
        end
  | _, _ => None
...
Definition divlu_exact (v1 v2: val): option val :=
  match v1, v2 with
  | Vlong n1, Vlong n2 =>
      match Int64.divu_exact n1 n2 with
      | Some v => Some (Vlong v)
      | None => None
      end
  | _, _ => None
...
Lemma cmp_bool_eq_true:
  forall v1 v2
         (CMP : cmp_bool Ceq v1 v2 = Some true), v1 = v2.
Proof.
  intros.
  destruct v1; destruct v2; cbn in *; try congruence.
...
Lemma cmpu_bool_eq_true:
  forall v1 v2
         (CMP : cmpu_bool Ceq v1 v2 = Some true), v1 = v2.
Proof.
  intros.
  destruct v1; destruct v2; cbn in *; try congruence.
  - pose proof (Int.eq_spec i i0).
  ...
  - destruct Archi.ptr64. discriminate.
    destruct Int.eq. 2: discriminate.
    destruct (_ && _); discriminate.
  - destruct Archi.ptr64. discriminate.
    destruct eq_block.
    + subst.
...
Definition select (cmp: option bool) (v1 v2: val) :=
  match cmp with
  | Some b => if b then v1 else v2
  | None => Vundef
  end.
...
Definition load_result (chunk: memory_chunk) (v: val) :=
  ...
  | Mint32al1, Vint n => Vint n
  | Mint32al1, Vptr b ofs => if Archi.ptr64 then Vundef else Vptr b ofs
  | Mint64, Vlong n => Vlong n
  | Mint64, Vptr b ofs => if Archi.ptr64 then Vptr b ofs else Vundef
  | Mint64al1, Vlong n => Vlong n
  | Mint64al1, Vptr b ofs => if Archi.ptr64 then Vptr b ofs else Vundef
...
Lemma select_lessdef:
  forall ob ob' v1 v1' v2 v2',
  ob = None \/ ob = ob' ->
  lessdef v1 v1' -> lessdef v2 v2' ->
  lessdef (select ob v1 v2) (select ob' v1' v2').
Proof.
...
Lemma select_inject:
  ...
  inject f (select ob v1 v2) (select ob' v1' v2').
Proof.
  intros; unfold select. destruct H.
- subst ob; auto.
- subst ob'; destruct ob as [[]|]; auto.
Qed.
...
(** Bitwise conversions for floats *)
...
Lemma float_bits_normalize:
  forall v1,
  float_of_bits (normalize (bits_of_float v1) AST.Tlong) =
  normalize v1 AST.Tfloat.
Proof.
...
Lemma single_bits_normalize:
  forall v1,
  single_of_bits (normalize (bits_of_single v1) AST.Tint) =
  normalize v1 AST.Tsingle.
Proof.
  destruct v1; cbn; trivial.
  f_equal.
...
(** Slight generalization of Val.offset_ptr *)

Definition addptr (v1 v2: val): val := if Archi.ptr64 then Val.addl v1 v2 else Val.add v1 v2.
Definition of_ptrofs (ofs:ptrofs): val := if Archi.ptr64 then Vlong (Ptrofs.to_int64 ofs) else Vint (Ptrofs.to_int ofs).

Lemma addptr_ptrofs b i ofs:
  Val.addptr (Vptr b i) (Val.of_ptrofs ofs) = Vptr b (Ptrofs.add i ofs).
Proof.
  unfold Val.addptr, Val.of_ptrofs; simpl. destruct Archi.ptr64 eqn: X.
  - rewrite Ptrofs.of_int64_to_int64; auto.
  - rewrite Ptrofs.of_int_to_int; auto.
Qed.

Lemma addptr_ptrofs_lessdef v ofs:
  Val.lessdef (Val.offset_ptr v ofs) (Val.addptr v (Val.of_ptrofs ofs)).
Proof.
  case (Val.eq (Val.offset_ptr v ofs) Vundef).
  + intros ->; econstructor.
  + destruct v; simpl; try congruence.
    rewrite Val.addptr_ptrofs; auto.
Qed.

Lemma addptr_ptrofs_inv v b i ofs:
  Val.addptr v (Val.of_ptrofs ofs) = Vptr b i -> exists i', v = Vptr b i' /\ i = Ptrofs.add i' ofs.
Proof.
  unfold Val.addptr, Val.of_ptrofs; destruct v; simpl; destruct Archi.ptr64 eqn: X; try discriminate;
  rewrite ?Ptrofs.of_int64_to_int64, ?Ptrofs.of_int_to_int; auto; injection 1; intros; subst; eexists; eauto.
Qed.

Lemma addptr_ptrofs_alt v b i ofs:
 Val.addptr v (Val.of_ptrofs ofs) = Vptr b i -> Val.addptr v (Val.of_ptrofs ofs) = Val.offset_ptr v ofs.
Proof.
  intros; feapply Val.addptr_ptrofs_inv; subst; simpl; auto.
Qed.

Remark addptr_inject:
  forall f v1 v1' v2 v2',
  inject f v1 v1' ->
  inject f v2 v2' ->
  inject f (Val.addptr v1 v2) (Val.addptr v1' v2').
Proof.
  intros. unfold Val.addptr. destruct Archi.ptr64 eqn:SF.
  - apply Val.addl_inject; auto.
  - apply Val.add_inject; auto.
Qed.

Definition addnull (v: val):= Val.addptr v Vnullptr.

Lemma addnull_lessdef v: Val.lessdef (addnull v) v.
Proof.
  unfold addnull, addptr, Vnullptr; destruct v; simpl; destruct Archi.ptr64 eqn: X; simpl; auto.
  - rewrite Int.add_commut, Int.add_zero_l; auto.
  - rewrite Int64.add_commut, Int64.add_zero_l; auto.
  - rewrite Ptrofs.add_commut, Ptrofs.add_zero_l; auto.
  - rewrite Ptrofs.add_commut, Ptrofs.add_zero_l; auto.
Qed.

Lemma addnull_add v1 v2: Archi.ptr64 = false -> addnull (Val.add v1 v2) = Val.add v1 v2.
Proof.
  unfold addnull, addptr, Vnullptr, addl; destruct v1; simpl; intros EQ; rewrite EQ; auto;
  destruct v2; simpl; rewrite ?EQ; auto.
  - rewrite Int.add_commut, Int.add_zero_l; auto.
  - rewrite Ptrofs.add_commut, Ptrofs.add_zero_l; auto.
  - rewrite Ptrofs.add_commut, Ptrofs.add_zero_l; auto.
Qed.

Lemma addnull_addl v1 v2: Archi.ptr64 = true -> addnull (Val.addl v1 v2) = Val.addl v1 v2.
Proof.
  unfold addnull, addptr, Vnullptr, addl; destruct v1; simpl; intros EQ; rewrite EQ; auto;
  destruct v2; simpl; rewrite ?EQ; auto.
  - rewrite Int64.add_commut, Int64.add_zero_l; auto.
...
Lemma addnull_addptr v1 v2: addnull (Val.addptr v1 v2) = Val.addptr v1 v2.
Proof.
  unfold addnull, addptr at 2 3. destruct Archi.ptr64 eqn: X.
  - apply addnull_addl; auto.
  - apply addnull_add; auto.
Qed.

Lemma addnull_offset_ptr v ofs: addnull (Val.offset_ptr v ofs) = Val.offset_ptr v ofs.
Proof.
  unfold addnull, addptr, Vnullptr; destruct v; simpl; destruct Archi.ptr64 eqn: X; simpl; 
  auto;
  rewrite ?Ptrofs.agree64_of_int_eq with (a:=Ptrofs.zero), ?Ptrofs.agree32_of_int_eq with (a:=Ptrofs.zero) by auto with ptrofs;
  rewrite Ptrofs.add_commut, Ptrofs.add_zero_l; auto.
Qed.

Lemma addnull_Vptr b ofs: addnull (Vptr b ofs) = Vptr b ofs.
Proof.
  unfold addnull, addptr, Vnullptr; simpl; destruct Archi.ptr64 eqn: X; simpl; auto;
  rewrite ?Ptrofs.agree64_of_int_eq with (a:=Ptrofs.zero), ?Ptrofs.agree32_of_int_eq with (a:=Ptrofs.zero) by auto with ptrofs;
  rewrite Ptrofs.add_commut, Ptrofs.add_zero_l; auto.
Qed.

Lemma addnull_Vptr_inv v b ofs: addnull v = Vptr b ofs -> v = Vptr b ofs.
Proof.
  destruct (addnull_lessdef v); congruence.
Qed.

Definition isfinitef (x : val) :=
  match x with
  | Vsingle f => Some (Binary.is_finite _ _ f)
  | _ => None
  end.

Definition isfinite (x : val) :=
  match x with
  | Vfloat f => Some (Binary.is_finite _ _ f)
  | _ => None
  end.

(** Count leading zeros *)

Definition clz (v: val): val :=
  match v with
  | Vint n => Vint (Int.clz n)
  | _ => Vundef
  end.

Definition clzl (v: val): val :=
  match v with
  | Vlong n => Vlong (Int64.clz n)
  | _ => Vundef
  end.

Lemma clz_shru5: forall n,
  shru (clz (Vint n)) (Vint (Int.repr 5)) = of_bool (Int.eq n Int.zero).
Proof.
  intros. unfold clz, shru; simpl.
  change (Int.ltu (Int.repr 5) Int.iwordsize) with true; simpl.
  rewrite int_clz_shru5. destruct (Int.eq n Int.zero); reflexivity.
Qed.

Lemma clzl_shrlu6: forall n,
  shrlu (clzl (Vlong n)) (Vint (Int.repr 6)) =
  Vlong (if Int64.eq n Int64.zero then Int64.one else Int64.zero).
Proof.
  intros. unfold clzl, shrlu; simpl.
  change (Int.ltu (Int.repr 6) Int64.iwordsize') with true; simpl.
  f_equal. apply int64_clz_shru6'.
Qed.
...
Axiom canary32_val: unit -> int.
Axiom canary64_val: unit -> int64.
Definition canary_val (_ : unit) := if Archi.canary64 then Vlong (canary64_val tt) else Vint (canary32_val tt).
Definition canary_type := if Archi.canary64 then Tlong else Tint.

Lemma canary_has_type: Val.has_type (canary_val tt) canary_type.
Proof.
  unfold canary_val, canary_type.
  destruct Archi.canary64; constructor.
Qed.

Lemma canary_inject : forall F, Val.inject F (canary_val tt) (canary_val tt).
Proof.
  intro. unfold canary_val.
  destruct Archi.canary64; constructor.
Qed.

Theorem Vcmp_single_float_exact:
  forall cmp x y
    (EQ: double_representable_as_single y),
    Val.cmpf_bool cmp (Val.floatofsingle x) (Vfloat y) =
      Val.cmpfs_bool cmp x (Vsingle (Float.to_single y)).
Proof.
  destruct x; intros; try reflexivity.
  simpl. f_equal.
  apply Floats.cmp_single_float_exact. assumption.
Qed.

Theorem Veq_single_float_not_exact:
  forall x y
    (NEQ: ~(double_representable_as_single y)) b,
    (Val.cmpf_bool Ceq (Val.floatofsingle x) (Vfloat y)) = Some b -> b = false.
Proof.
  destruct x; intros; try discriminate.
  simpl in H. injection H. clear H. intro H. symmetry in H.
  rewrite Floats.eq_single_float_not_exact in H; assumption.
Qed.

Theorem Vne_single_float_not_exact:
  forall x y
    (NEQ: ~(double_representable_as_single y)) b,
    (Val.cmpf_bool Cne (Val.floatofsingle x) (Vfloat y)) = Some b -> b = true.
Proof.
  destruct x; intros; try discriminate.
  simpl in H. injection H. clear H. intro H. symmetry in H.
  rewrite Floats.ne_single_float_not_exact in H; assumption.
Qed.

Theorem Vgt_single_float: forall x y,
    Val.cmpf_bool Cgt (Val.floatofsingle x) (Vfloat y) =
      Val.cmpfs_bool Cgt x (Vsingle (Float.to_single_DN y)).
Proof.
  intros. destruct x; try reflexivity. simpl. f_equal.
  apply Floats.gt_single_float.
Qed.

Theorem Vge_single_float: forall x y,
    Val.cmpf_bool Cge (Val.floatofsingle x) (Vfloat y) =
      Val.cmpfs_bool Cge x (Vsingle (Float.to_single_UP y)).
Proof.
  intros. destruct x; try reflexivity. simpl. f_equal.
  apply Floats.ge_single_float.
Qed.
  
Theorem Vlt_single_float: forall x y,
    Val.cmpf_bool Clt (Val.floatofsingle x) (Vfloat y) =
      Val.cmpfs_bool Clt x (Vsingle (Float.to_single_UP y)).
Proof.
  intros. destruct x; try reflexivity. simpl. f_equal.
  apply Floats.lt_single_float.
Qed.

Theorem Vle_single_float: forall x y,
    Val.cmpf_bool Cle (Val.floatofsingle x) (Vfloat y) =
      Val.cmpfs_bool Cle x (Vsingle (Float.to_single_DN y)).
Proof.
  intros. destruct x; try reflexivity. simpl. f_equal.
  apply Floats.le_single_float.
Qed.
