...
Parameter has_unaligned_int32 : unit -> bool.
Definition has_notrap_loads := false.
Definition has_mulhu := true.
Definition has_mulhs := true.
Definition has_mullhu := true.
Definition has_mullhs := true.
